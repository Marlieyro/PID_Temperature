...
#define BME280_VAL_CHIP_ID (0x60)

// ------------- Slave adrr -------------
// Shifted Corresponding to I2C doc
#define BME280_VAL_SLAVE_ADRR (0x76 << 1)
#define BME280_VAL_SLAVE_ADRR_ALTERNATIVE (0x77 << 1)
...
HAL_StatusTypeDef BME280_GetChipID(uint8_t *pData);
